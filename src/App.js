...
function App() {
  ...
  {/* Beginner Level */}
  <div className="py-10">
    <h4 className="text-2xl py-2 font-bold dark:text-white text-center">
      Beginner Level
    </h4>
    ...
    <div className="basis-1/3 flex-1">
        ...
        <p className="text-red-600">
          Random Advice Generator made using ReactJs with advice API.<br />
      ...
      <div className="basis-1/3 flex-1">
        ...
        <p className="text-red-600">
          ToDo Application made using ReactJs with localStorage.<br />
  ...
  <div className="py-10">
    ...
    <div className="basis-1/3 flex-1">
        ...
        <p className="text-red-600">
          Ecommerce website made using PHP, MySQL, and HTML.<br />
          Users can login, sign in, add items to the cart, and proceed to payment.
        </p>
        <div className="flex justify-center mt-4">
          <a
            href="" target="_blank"
  ...
  <div className="py-10">
    ...
    <div className="flex flex-col gap-10 lg:flex-row lg:flex-wrap">
      <div className="basis-1/3 flex-1">
        ...
        <p className="text-red-600">
          A mern stack workout website made using mongodb reactjs express nodejs<br></br> where user can add information about his workout and <br></br>he can delete the workout and all the workouts will be save on the database.
        </p>
        <div className="flex justify-center mt-4">
          <a
            href="" target="_blank"
      ...
      <div className="basis-1/3 flex-1">
        ...
        <p className="text-red-600">
          A crypto currency website made using ReactJs and rapid API through which <br></br> users can easily acess the data of every crypto currency <br></br> and user can get the data through visiual representation.
        </p>
        <div className="flex justify-center mt-4">
          <a
            href="https://github.com/AshutoshRajGupta/cryptoworld" target="_blank"
            className="btn-primary mr-30 px-4 py-2 bg-teal-600 text-white border border-teal-600 hover:bg-teal-800 hover:border-teal-800"
          >
            Github
          </a>
